...
The error messaged indicated that nothing was being returned in a specific function on line 131. Added a return statement to the start of line 132, this fixes the issue and now returns a value for the function.
